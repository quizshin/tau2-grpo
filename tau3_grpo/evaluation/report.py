...
bootstrap between two arms, and writes `report.json`.
    ...
    python -m tau3_grpo.evaluation.report --arm e0 results/e0/telemetry.jsonl \
...
from tau3_grpo.evaluation.metrics import paired_bootstrap_by_task
from tau3_grpo.paths import RESULTS_ROOT, verify_layout
from tau3_grpo.tracking.telemetry import build_report, write_report
