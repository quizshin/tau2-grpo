...
def main():
    ...
    base = load_policy_model(str(model_path), torch_dtype=torch.float32,
    ...
    optimizer = torch.optim.AdamW(trainable, lr=2e-5, weight_decay=0, fused=True)
    ...
    output = RESULTS_ROOT / "full-sft-preflight"
