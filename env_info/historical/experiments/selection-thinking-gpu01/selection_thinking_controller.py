...
R=Path('/root/autodl-fs/tau3-core');W=R / 'code/results/legacy/experiments/selection-thinking-gpu01'
...
try:
 ...
 for method in ['on']:
  ...
  completion=classify_completion(W/('results-'+method),rc)
  (W/('completion-'+method+'.json')).write_text(json.dumps(completion,indent=2))
  print('Finished selection',method,completion,flush=True)
