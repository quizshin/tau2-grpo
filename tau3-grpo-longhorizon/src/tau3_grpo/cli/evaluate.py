...
never be used to choose a model.
    ...
    python -m tau3_grpo.cli.evaluate --target selection --seed 42 \
        --checkpoint results/e3_seed42/global_step_40/merged_hf
    python -m tau3_grpo.cli.evaluate --target tau3-final \
        --checkpoint results/e3_seed42/global_step_40/merged_hf
"""
...
from tau3_grpo.experiment.eval_runtime import Endpoint, EvalSpec, run_evaluation
from tau3_grpo.experiment.service_attestation import (
    ServiceAttestationError,
    assert_service_matches_checkpoint,
)
from tau3_grpo.experiment.winner_lock import WinnerLockError, assert_final_run_allowed
from tau3_grpo.paths import MANIFEST_ROOT, RESULTS_ROOT, verify_four_root_layout
from tau3_grpo.tau2_bridge import Tau2Unavailable
